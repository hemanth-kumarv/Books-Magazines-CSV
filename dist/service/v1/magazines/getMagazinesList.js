...
exports.getMagazinesList = void 0;
 ...
 */
const getMagazinesList = (query) => new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
    const results = [];
    const authorsMap = yield (0, getAuthorsList_1.getAuthorsList)();
    fs_1.default.createReadStream(path_1.default.join(__dirname, "/../../../assets/magazines.csv"))
        ...
        let filteredResults = query
            ? results === null || results === void 0 ? void 0 : results.filter((magazine) => {
                var _a, _b;
                return ((_a = magazine.title) === null || _a === void 0 ? void 0 : _a.includes(query)) ||
                    ((_b = magazine.authors) === null || _b === void 0 ? void 0 : _b.findIndex((author) => { var _a; return (_a = author.email) === null || _a === void 0 ? void 0 : _a.includes(query); })) > -1;
            })
...
exports.getMagazinesList = getMagazinesList;
